...
export const Route = createFileRoute("/v3/library/")({
  head: () => ({ meta: [{ title: "Библиотека — PerfOps V3" }] }),
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y">
            {filtered.map((e) => {
              ...
              const downloadable = e.format === "excel" || e.format === "source-file";
