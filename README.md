...
Lovable-прототип и UI-контракт продуктовой платформы **PerfOps**. Репозиторий используется только для согласования UI/UX и не содержит production-кода, реальных API-ключей и приватных env-файлов.
